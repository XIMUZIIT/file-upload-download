...
public class FileConfig {
	private Map<String, String> contentType = new HashMap<String, String>(200) {
		{
			put(".load", "text/html");
	...
	@Value("${cmss.fileserver.filepath}")
	public String filepath;

	public String getContentType(String ext) {
		String ct = contentType.get(ext);
		if (ct == null) {
